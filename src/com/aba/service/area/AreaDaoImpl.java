...
import com.aba.util.JsonUtils;
import com.aba.util.ReadWebUtil;

public class AreaDaoImpl implements AreaDao {

	private String host = "http://60.247.57.205:8180/strategyapi" ;
...
//		.append("|").append(result.getMatches().size())
	...
	public AreaResult findAreaByParentId(AreaRequest request) {
		...
		StringBuffer url = new StringBuffer(host) ;
		url.append("/area_by_parentid.do?pid=u01&vt=1&pt=1&parentid=").append(request.getId()) ;
